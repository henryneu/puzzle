package henry.neu.cn.puzzle.adapter;
...
/**
 * 拼图游戏主界面GridView数据适配器
 * <p>
 * Created by henryneu on 2017/2/25.
 */
...
public class GridItemsAdapter extends BaseAdapter {
    ...
    public GridItemsAdapter(List<Bitmap> picList, Context mContext) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            // 设置布局图片
            iv_pic_item.setLayoutParams(new GridView.LayoutParams(mBitmapItemLists.get(position).getWidth(),
